...
class VideoService:
    ...
    async def with_audio(self, image_asset_id: str, audio_asset_id: str, model_id: str) -> dict:
    ...
    async def with_inline_tts(self, image_asset_id: str, voice_id: str, text: str, model_id: str) -> dict:
